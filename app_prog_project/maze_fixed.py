...
def mazf(seedd):
    ...
    with open(seedd) as f: # import a maze, list of direction of have pygame shape out the maze 
    ...
    def solution_cell(x,y):
        a=pygame.draw.rect(screen, YELLOW, (x+8, y+8, 5, 5), 0)             # used to show the solution
        pygame.display.update()                                        # has visited cell
